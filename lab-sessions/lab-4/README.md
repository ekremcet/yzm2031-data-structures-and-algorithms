...
- **Your task:** Identify and implement a **stable** sorting algorithm.
...
- **Your task:** Identify which O(n²) algorithm becomes nearly O(n) on almost-sorted data.
...
- **Your task:** Implement a **non-comparison-based** sorting algorithm.

**Deliverables:**
1. Implement the correct sorting algorithm for each client.
2. Write a justification comment explaining **why** you chose that algorithm.
3. All three test cases must pass.
